...
![docs/image/进程安全-系统调用沙箱/opensbi.png](docs/image/进程安全-系统调用沙箱/opensbi.png)
![docs/image/进程安全-系统调用沙箱/xv6_qemu.png](docs/image/进程安全-系统调用沙箱/xv6_qemu.png)
...
![docs/image/进程安全-系统调用沙箱/cat_README.png](docs/image/进程安全-系统调用沙箱/cat_README.png)
...
![docs/image/进程安全-系统调用沙箱/sandbox_policy_nofile_README.png](docs/image/进程安全-系统调用沙箱/sandbox_policy_nofile_README.png)
...
![docs/image/进程安全-系统调用沙箱/sandbox+mkdir+rm+ls.png](docs/image/进程安全-系统调用沙箱/sandbox+mkdir+rm+ls.png)
...
![docs/image/进程安全-系统调用沙箱/strace_rm.png](docs/image/进程安全-系统调用沙箱/strace_rm.png)
...
![docs/image/进程安全-系统调用沙箱/wsl创建镜像.png](docs/image/进程安全-系统调用沙箱/wsl创建镜像.png)
2. xv6：`ls /etc` 显示 policy 文件已打包  
![docs/image/进程安全-系统调用沙箱/ls_etc.png](docs/image/进程安全-系统调用沙箱/ls_etc.png)
3. Baseline：`cat README` 正常输出  
![docs/image/进程安全-系统调用沙箱/cat_README.png](docs/image/进程安全-系统调用沙箱/cat_README.png)
4. deny open：`sandbox policy_nofile cat README` 失败输出  
![docs/image/进程安全-系统调用沙箱/sandbox_policy_nofile_README(-k+-e).png](docs/image/进程安全-系统调用沙箱/sandbox_policy_nofile_README(-k+-e).png)
